										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="https://www.wponlinesupport.com/plugins-documentation/document-wp-responsive-faq-with-category-plugin/?utm_source=hp&event=doc" target="_blank"><?php _e('Documentation', 'sp-faq'); ?></a>									
													<a class="button button-primary" href="http://demo.wponlinesupport.com/sp-faq/?utm_source=hp&event=demo" target="_blank"><?php _e('Demo for Designs', 'sp-faq'); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">										
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/sp-responsive-wp-faq-with-category-plugin/?utm_source=hp&event=go_premium" target="_blank"><?php _e('Go Premium ', 'sp-faq'); ?></a>	
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/pro-faq-plugin-demo/?utm_source=hp&event=pro_demo" target="_blank"><?php _e('View PRO Demo ', 'sp-faq'); ?></a>			</p>								
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">										
										<p>Enjoyed this plugin? You can help by rate this plugin <a href="https://wordpress.org/support/plugin/sp-faq/reviews/?filter=5" target="_blank">5 stars!</a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
