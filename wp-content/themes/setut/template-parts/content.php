...
<article class="news-list" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="blog-item-wrap category-home">
			...
			<div class="block-content-info">
				...
				<div class="entry-summary">
					...
					<p>
						...
						<a class="btn btn-default read-more" href="<?php the_permalink(); ?>">
							<?php esc_html_e( 'Read More', 'sparkling' ); ?>
						</a>
					</p>
				</div><!-- .entry-summary -->
				...
				<div class="entry-content">
					...
					if ( get_theme_mod( 'sparkling_excerpts' ) == 1 ) :
						the_excerpt();?>
						<p>
							<a class="btn btn-default read-more" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html_e( 'Read More', 'sparkling' ); ?>
							</a>
						</a>
						</p>
					<?php else :
						
						echo more_text($post->post_content, 200);
